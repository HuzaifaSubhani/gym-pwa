    ...
    <main className="flex-1 flex flex-col min-h-[100dvh] items-center bg-noir-bg p-4 md:p-8 overflow-y-auto relative">
      ...
      <div className="w-full max-w-md bg-noir-surface/80 backdrop-blur-md border border-noir-border rounded-2xl p-6 md:p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-500 my-auto z-10 flex-shrink-0">
        <header className="mb-8 text-center relative flex flex-col items-center">
          ...
          <div className="w-16 h-16 bg-noir-bg rounded-2xl border border-noir-border shadow-[0_0_20px_rgba(204,255,0,0.15)] flex items-center justify-center mb-4">
        ...
        <form onSubmit={handleAuth} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-noir-accent hover:opacity-90 text-noir-bg font-bold py-3 px-4 rounded-lg shadow-[0_0_15px_rgba(204,255,0,0.3)] transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed mt-6"
          >
